...
// (อ้างอิง: เควสทั่วไปได้ 10-15 P ผู้เล่นใหม่เห็น 4 เควส (สุ่มรายวัน) ≈ 46 P/วัน, Upgrade 1 สายเต็ม (booster)
...
const ITEMS = [
  ...
  },
  {
    ...
    // ⚠️ 150 P (เดิม 70) — ผู้ใช้ตัดสินใจให้เป็นไอเทมกลาง-ปลายเกม ผู้เล่นใหม่ต้องเล่นจากการทำเควสก่อน
    // (ไม่ล็อกด้วยเลเวล ใช้ราคาคุมอย่างเดียว) ทำเควสซ้ำได้เฉลี่ย 12 P/อัน → คืนทุนต้องเห็นเควส ≥13 จาก 16
    // (Quest Unlock ~Lv.9) ถ้าไม่มีบัฟได้กำไรสูงสุดแค่ ~27% (190 P) ต้องมี Point Booster ด้วยถึงคุ้มจริง
    // ผู้เล่นใหม่ 4 เควส (~46 P) ซื้อ = ขาดทุนแน่นอน ตัวเลขจำลองดู BALANCE_REPORT.md
    cost: 150,
    effect: 'super_energy',
  },
